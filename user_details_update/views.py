...
def all_user_details_views(request, email, admin):
    if admin:
        try:
    ...
    return jsonify({'message': 'you cant access this page as you dont have admin access'})


def user_details_update_views(request, email, admin):
    try:
        ...
        for item in payload:
            ...
            column_name = item
            value_to_be_updated = payload[item]
